...
import com.shida.eduorder.entity.PayLog;
import com.shida.eduorder.mapper.PayLogMapper;
import com.shida.eduorder.service.OrderService;
import com.shida.eduorder.service.PayLogService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.shida.eduorder.utils.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNative(String orderNo) {
        try {
            ...
            //3 发送HeepClient请求，传递参数xml格式，微信支付提供的固定的地址
            ...
            throw new LeOndeException(20001,"二维码生成失败");
        }
    }
